...
public class Mahasararam extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mahasararam);
    }
    public void button30 (View view) {
        Intent intent = new Intent(Mahasararam.this,Road.class);
    ...
    public  void button31 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดราชประดิษฐสถิดมหาสิมาราม");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
