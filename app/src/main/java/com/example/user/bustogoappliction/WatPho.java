...
public class WatPho extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wat_pho);
    }
    public void button38 (View view) {
        Intent intent = new Intent(WatPho.this,Road.class);
    ...
    public  void button39 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดโพธิ์");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
