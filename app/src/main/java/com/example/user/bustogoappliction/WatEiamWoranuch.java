...
public class WatEiamWoranuch extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wat_eiam_woranuch);
    }
    public void button60 (View view) {
        Intent intent = new Intent(WatEiamWoranuch.this,Road.class);
    ...
    public  void button61 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดเอียมวรนุช");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
