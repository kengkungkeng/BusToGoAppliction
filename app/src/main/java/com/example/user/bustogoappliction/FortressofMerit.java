...
public class FortressofMerit extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fortressof_merit);
    }
    public void button62 (View view) {
        Intent intent = new Intent(FortressofMerit.this,Road.class);
    ...
    public  void button63 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "ป้อมพระสุเมรุ");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
