...
public class WatTritvatthamWorawiharn extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wat_tritvattham_worawiharn);
    }
    public void button18 (View view) {
        Intent intent = new Intent(WatTritvatthamWorawiharn.this,Road.class);
    ...
    public  void button19 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดตรีทศเทพวรวิหาร");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
