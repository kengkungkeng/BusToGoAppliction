...
public class Santichai extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_santichai);
    }
    public void button70 (View view) {
        Intent intent = new Intent(Santichai.this,Road.class);
    ...
    public  void button71 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "สวนสาธารณะสันติชัย");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
