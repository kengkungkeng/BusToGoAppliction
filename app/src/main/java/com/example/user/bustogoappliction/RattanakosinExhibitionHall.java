...
public class RattanakosinExhibitionHall extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rattanakosin_exhibition_hall);
    }
    public void button12 (View view) {
        Intent intent = new Intent(RattanakosinExhibitionHall.this,Road.class);
    ...
    public  void button13 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "อาคารนิทรรศน์รัตนโกสินทร์");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
