...
public class BangkokCityPillarShrine extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bangkok_city_pillar_shrine);
    }

    public void button8 (View view) {
        Intent intent = new Intent(BangkokCityPillarShrine.this,Road.class);
    ...
    public  void button9 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "ศาลหลักเมือง");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
