...
public class WatSuthepVisawaram extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wat_suthep_visawaram);
    }
    public void button26 (View view) {
        Intent intent = new Intent(WatSuthepVisawaram.this,Road.class);
    ...
    public  void button27 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดสังเวชวิศยาราม");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
