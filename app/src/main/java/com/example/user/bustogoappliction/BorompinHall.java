...
public class BorompinHall extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_borompin_hall);
    }
    public void button10 (View view) {
        Intent intent = new Intent(BorompinHall.this,Road.class);
    ...
    public  void button11 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "พระที่นั่งบรมพิมาน");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
