...
public class WatLeed extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wat_leed);
    }
    public void button52 (View view) {
        Intent intent = new Intent(WatLeed.this,Road.class);
    ...
    public  void button53 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดราชบูรณะราชวรวิหาร(วัดเลียบ)");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
