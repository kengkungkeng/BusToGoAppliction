...
public class PromPalace extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_prom_palace);
    }
    public void button40 (View view) {
        Intent intent = new Intent(PromPalace.this,Road.class);
    ...
    public  void button41 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "ตำหนักวังบางขุนพรหม");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
