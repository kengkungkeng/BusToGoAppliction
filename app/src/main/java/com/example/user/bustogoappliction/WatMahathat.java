...
public class WatMahathat extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wat_mahathat);
    }
    public void button44 (View view) {
        Intent intent = new Intent(WatMahathat.this,Road.class);
    ...
    public  void button45 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดมหาธาตุยุวราชรังสฤษฏิ์ราชวรมหาวิหาร");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
