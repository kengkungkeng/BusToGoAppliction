...
public class WatMahanaram extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wat_mahanaram);
    }
    public void button48 (View view) {
        Intent intent = new Intent(WatMahanaram.this,Road.class);
    ...
    public  void button49 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดมหรรณพาราม");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
