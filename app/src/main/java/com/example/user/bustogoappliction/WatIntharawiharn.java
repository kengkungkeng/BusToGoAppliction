...
public class WatIntharawiharn extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wat_intharawiharn);
    }
    public void button58 (View view) {
        Intent intent = new Intent(WatIntharawiharn.this,Road.class);
    ...
    public  void button59 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดอินทรวิหาร");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
