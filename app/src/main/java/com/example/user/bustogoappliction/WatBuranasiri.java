...
public class WatBuranasiri extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wat_buranasiri);
    }
    public void button66 (View view) {
        Intent intent = new Intent(WatBuranasiri.this,Road.class);
    ...
    public  void button67 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดบุรณศิริมาตยาราม");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
