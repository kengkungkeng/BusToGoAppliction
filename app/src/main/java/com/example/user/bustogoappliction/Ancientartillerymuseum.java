...
public class Ancientartillerymuseum extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ancientartillerymuseum);
    }
    public void button16 (View view) {
        Intent intent = new Intent(Ancientartillerymuseum.this,Road.class);
    ...
    public  void button17 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "พิพิธภัณฑ์ปืนใหญ่โบราณ");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
