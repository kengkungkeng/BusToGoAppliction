...
public class SanamLuang extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sanam_luang);
    }
    public void button68 (View view) {
        Intent intent = new Intent(SanamLuang.this,Road.class);
    ...
    public  void button69 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "สนามหลวง");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
