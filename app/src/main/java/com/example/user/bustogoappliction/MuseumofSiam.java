...
public class MuseumofSiam extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_museumof_siam);
    }
    public void button24 (View view) {
        Intent intent = new Intent(MuseumofSiam.this,Road.class);
    ...
    public  void button25 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วมิวเซียมสยาม");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
