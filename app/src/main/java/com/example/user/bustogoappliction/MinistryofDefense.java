...
public class MinistryofDefense extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ministryof_defense);
    }
    public void button56 (View view) {
        Intent intent = new Intent(MinistryofDefense.this,Road.class);
    ...
    public  void button57 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "กระทรวงกลาโหม");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
