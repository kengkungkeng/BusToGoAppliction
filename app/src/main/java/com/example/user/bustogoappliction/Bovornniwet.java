...
public class Bovornniwet extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bovornniwet);
    }
    public void button74 (View view) {
        Intent intent = new Intent(Bovornniwet.this,Road.class);
    ...
    public  void button75 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดบวรนิเวศ ราชวรวิหาร");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
