...
public class NaranatSuntarikaram extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_naranat_suntarikaram);
    }
    public void button42 (View view) {
        Intent intent = new Intent(NaranatSuntarikaram.this,Road.class);
    ...
    public  void button43 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดนรนาถสุนทริการาม");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
