...
public class WatSamPhraya extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wat_sam_phraya);
    }
    public void button28 (View view) {
        Intent intent = new Intent(WatSamPhraya.this,Road.class);
    ...
    public  void button29 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดสามพระยา");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
