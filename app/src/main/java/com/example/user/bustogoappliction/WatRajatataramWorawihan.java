...
public class WatRajatataramWorawihan extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wat_rajatataram_worawihan);
    }
    public void button34 (View view) {
        Intent intent = new Intent(WatRajatataramWorawihan.this,Road.class);
    ...
    public  void button35 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดราชนัตตารามวรวิหาร");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
