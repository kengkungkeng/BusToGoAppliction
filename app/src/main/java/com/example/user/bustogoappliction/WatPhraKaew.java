...
public class WatPhraKaew extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wat_phra_kaew);
    }
    public void button36 (View view) {
        Intent intent = new Intent(WatPhraKaew.this,Road.class);
    ...
    public  void button37 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดพระศรีรัตนศาสดาราม วัดพระแก้ว");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
