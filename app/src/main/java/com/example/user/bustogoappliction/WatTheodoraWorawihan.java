...
public class WatTheodoraWorawihan extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wat_theodora_worawihan);
    }
    public void button22 (View view) {
        Intent intent = new Intent(WatTheodoraWorawihan.this,Road.class);
    ...
    public  void button23 (View view){
        ...
        Uri location = Uri.parse("http://maps.google.co.in/maps?q=" + "วัดเทพดารามวรวิหาร");  // พิมพ์ชื่อสถานที่จะไปก็ไปได้เลย
